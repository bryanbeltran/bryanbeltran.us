...
SeedStarter currently lives somewhere between a concept and a minimum viable product. The idea is straightforward: you enter your zip code, pick a few common crops, and it tells you when to start seeds indoors and when to transplant them. From there, it generates a `.ics` file you can drop straight into your calendar.
